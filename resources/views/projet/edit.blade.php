            ...
            <div class="projet_create-wrapper">
                <div class="projet_create-info neumorphisme">
                    <div class="projet_create-info-nom ">
                        ...
                        <input name="nom" type="text" class="input_neumorphisme" placeholder="Entrer le titre du projet" value="{{$projet->nom}}">
                    </div>
                    ...
                    <div class="projet_create-info-date">
                        ...
                        <input type="date" name="echeance" class="input_neumorphisme" placeholder="Entrer la date limite" value="{{$projet->echeance}}">
                    </div>
                </div>
